...
extension Int: StringRepresentable { 
    public static var hasDefaultValue: Int {
        0
    }
}

extension Int64: StringRepresentable {
    public static var hasDefaultValue: Int64 {
        0
    }
}

extension Float: StringRepresentable {
    public static var hasDefaultValue: Float {
        0.0
    }
}

extension Double: StringRepresentable {
    public static var hasDefaultValue: Double {
        0.0
    }
}
